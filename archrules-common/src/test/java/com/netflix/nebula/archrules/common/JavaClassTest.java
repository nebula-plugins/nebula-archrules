...
public class JavaClassTest {
    ...
    public void test_resideInAPackageThat_true() {
        assertThat(JavaClass.Predicates.resideInAPackageThat(name("com.netflix.nebula.archrules.common.other"))
    ...
    public void test_resideInAPackageThat_false() {
        assertThat(JavaClass.Predicates.resideInAPackageThat(name("com.netflix.nebula.archrules.common"))
                .test(scanClass(ClassInOtherPackage.class)))
                .isFalse();
    }
